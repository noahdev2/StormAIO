...
namespace MightyAio.Champions
{
    internal class Lucian
    {
        ...
        {
            Menu = new Menu("MightyLucian", "Mighty Lucian", true);
        ...
        private static bool UseQC => Menu["Q"].GetValue<MenuBool>("QC");
        private static bool UseQH => Menu["Q"].GetValue<MenuBool>("QH");
        private static int UseQHM => Menu["Q"].GetValue<MenuSlider>("QMana").Value;
        private static bool UseQmaxRange => Menu["Q"].GetValue<MenuBool>("QE");
        private static bool UseWC => Menu["W"].GetValue<MenuBool>("WC");
        private static bool UseR => Menu["R"].GetValue<MenuBool>("RC");
        ...
        private static bool QLaneClear => Menu["laneclear"].GetValue<MenuBool>("Q");
        private static bool WLaneClear => Menu["laneclear"].GetValue<MenuBool>("W");
        private static bool ELaneClear => Menu["laneclear"].GetValue<MenuBool>("E");
        private static bool QjglClear => Menu["laneclear"].GetValue<MenuBool>("QJ");
        private static bool WjglClear => Menu["laneclear"].GetValue<MenuBool>("WJ");
        private static bool EjglClear => Menu["laneclear"].GetValue<MenuBool>("EJ");
        private static bool KSQ => Menu["KillSteal"].GetValue<MenuBool>("Q");
        private static bool KSW => Menu["KillSteal"].GetValue<MenuBool>("W");
        private static bool KSR => Menu["KillSteal"].GetValue<MenuBool>("R");
        ...
        public Lucian()
        {
            ...
            Q2.SetSkillshot(0.4f, 25f, int.MaxValue, false, SkillshotType.Line);
            W = new Spell(SpellSlot.W, 900);
            W.SetSkillshot(0.25f, 320f, 1600f, false, SkillshotType.Circle);
        ...
        private static void GameOnOnUpdate(EventArgs args)
        {
            ...
            if (!IsCastingR) Orbwalker.AttackState = true;
        ...
        private static void Combo()
        {
            ...
            {
                var positionAfterE = SpellPrediction.GetPrediction(qTarget, 300).UnitPosition;
            ...
            if (Q.IsReady() && UseQC && !HasPassiveBuff && !HasSheenBuff)
            {
                ...
                {
                    var predictedPosition = SpellPrediction.GetPrediction(target,
        ...
        private static void ELogics()
        {
            ...
            var castTime = Player.Spellbook.SpellCastTime - Variables.GameTimeTickCount;
