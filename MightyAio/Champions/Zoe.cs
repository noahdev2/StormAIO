...
namespace MightyAio.Champions
{
    internal class Zoe
    {
        ...
        public Zoe()
        {
            ...
            Q.SetSkillshot(0.25f, 100f, 1200, true, SkillshotType.Circle);
            Q2 = new Spell(SpellSlot.Q, 1000f);
            Q2.SetSkillshot(0.25f, 100f, 1200f, false, SkillshotType.Circle);
            E = new Spell(SpellSlot.E, 800f);
            E.SetSkillshot(0.5f, 100f, 2000, true, SkillshotType.Line); 
            E2 = new Spell(SpellSlot.E, int.MaxValue);
            E2.SetSkillshot(0.5f, 100f, 2000, true, SkillshotType.Line);
            R = new Spell(SpellSlot.R, 575);
            R.SetSkillshot(0.7f, 140f, 1500f, true, SkillshotType.Circle);
