...
namespace MightyAio.Champions
{
    ...
    internal class Jinx
    {
        ...
        private static bool Close => Menu["Combo"].GetValue<MenuBool>("WR");
        ...
        public Jinx()
        {
            ...
            W.SetSkillshot(0.60f, 80f, 3300f, true, SkillshotType.Line);
            E = new Spell(SpellSlot.E, 900f);
            E.SetSkillshot(0.95f, 120f, 1100f, false, SkillshotType.Circle);
            R = new Spell(SpellSlot.R, 30000f);
            R.SetSkillshot(0.60f, 140f, 1500f, false, SkillshotType.Line);
        ...
        {
            var usesound = Menu["Misc"].GetValue<MenuBool>("playsoundonR");
        ...
        private static void DrawingOnOnDraw(EventArgs args)
        {
            ...
            if (drawQ || PermaShow)
            {
                if (HasRocketLauncher)
                    Drawing.DrawCircle(p, SecondGunRange(), Color.DarkCyan);
                if (HasMinigun)
                    Drawing.DrawCircle(p, MiniGunRange(), Color.DarkCyan);
            }
        ...
        {
            var useonkill = Emotes.GetValue<MenuBool>("Kill");
        ...
        private static void Baseult()
        {
            ...
            if (objSpawnPoints != null)
            {
                ...
                if (target != null && target.IsValid)
                {
                    ...
                    if (a)
                    {
                        Game.SendPing(PingCategory.Danger, Player.Position);
                        return;
                    }
                }
        ...
        private static void LaneClear()
        {
            ...
            var useqT = Menu["laneclear"].GetValue<MenuBool>("UseQT");
        ...
        private static void Rsimi()
        {
            ...
            if (rtarget.IsValidTarget() && !rtarget.HasBuffOfType(BuffType.Invulnerability) &&
                ...
                if (R.IsReady())
                {
                    var rPred = R.GetPrediction(rtarget, true, -1, CollisionObjects.Heroes);
        ...
        {
            var useQ = Menu["Combo"].GetValue<MenuBool>("UseQ");
            var useW = Menu["Combo"].GetValue<MenuBool>("UseW");
            var useE = Menu["Combo"].GetValue<MenuBool>("UseE");
            var UseR1 = Menu["Combo"].GetValue<MenuBool>("UseR1");
            var useR = Menu["Combo"].GetValue<MenuBool>("UseRAoe");
            var useRAoenum = Menu["Combo"].GetValue<MenuSlider>("MiniRAoe").Value;
            if (Q.IsReady() && useQ)
            {
                var target = TargetSelector.GetTarget(SecondGunRange());
        ...
        {
            var UseW = Menu["KillSteal"].GetValue<MenuBool>("UseW");
        ...
        private static void Harass()
        {
            ...
            var target = TargetSelector.GetTarget(W.Range);
            bool useW = Menu["Harass"].GetValue<MenuBool>("UseW");
            bool useQ = Menu["Harass"].GetValue<MenuBool>("UseQ");
