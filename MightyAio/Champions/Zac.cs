...
namespace MightyAio.Champions
{
    internal class Zac
    {
        ...
        public static Font Berlinfont = new Font(Drawing.Direct3DDevice, new FontDescription
        {
        ...
        private void InitZac()
        {
            ...
            Q.SetSkillshot(0.55f, 120, float.MaxValue, false, SkillshotType.Line);
            W = new Spell(SpellSlot.W, 320);
            E = new Spell(SpellSlot.E);
            E.SetSkillshot(0.75f, 230, 1500, false, SkillshotType.Circle);
        ...
        {   
            ...
            if (item != "none")
            {
                if (item == "Hunters Talisman)")
                {
                    ...
                    {
                        if (gold >= 500 && !player.HasItem(ItemId.Hunters_Talisman))
                        {
                            player.BuyItem(ItemId.Hunters_Talisman);
                        }
            ...
            if (Menu["Misc"].GetValue<MenuBool>("autolevel") && player.Level < 18)
            {
                Levelup();
            }
        ...
        private void Harass()
        {
            AIHeroClient target = TargetSelector.GetTarget(Q.Range);
        ...
        private void Clear()
        {
            var QA = Menu["laneclear"].GetValue<MenuBool>("Q");
            var WA = Menu["laneclear"].GetValue<MenuBool>("W");
            var EA = Menu["laneclear"].GetValue<MenuBool>("E");
            var Blobs = Menu["laneclear"].GetValue<MenuBool>("B");
        ...
        private void Combo()
        {
            var num = Menu["R"].GetValue<MenuSlider>("RCT");
            var QA = Menu["Q"].GetValue<MenuBool>("QC");
            var WA = Menu["W"].GetValue<MenuBool>("WC");
            var EA = Menu["E"].GetValue<MenuBool>("EC");
            var RA = Menu["R"].GetValue<MenuBool>("RC");
        ...
        private void CastE(AIBaseClient target)
        {
            ...
            var enemyPred = SpellPrediction.GetPrediction(
        ...
        private static void Killsteal()
        {
            ...
            var WQA = Menu["KillSteal"].GetValue<MenuBool>("W");
        ...
        private void Game_OnDraw(EventArgs args)
        {
            ...
            if (drawQ  && Q.IsReady())
            {
                Drawing.DrawCircle(p, Q.Range, System.Drawing.Color.DarkCyan);
            }

            if (drawE && E.IsReady())
            {

                Drawing.DrawCircle(p, E.Range, System.Drawing.Color.Red);
            }

            if (drawR && R.IsReady())
            {
                Drawing.DrawCircle(p, R.Range, System.Drawing.Color.DarkCyan);
            }
