...
namespace MightyAio.Champions
{
    internal class Riven
    {
        ...
        private static bool KillstealW => Menu["KillSteal"].GetValue<MenuBool>("W");
        private static bool KillstealR => Menu["KillSteal"].GetValue<MenuBool>("R");
        ...
        private static bool AutoShield => Menu["E"].GetValue<MenuBool>("AutoShield");
        private static bool Shield => Menu["E"].GetValue<MenuBool>("Shield");
        private static bool KeepQ => Menu["Q"].GetValue<MenuBool>("KeepQ");
        ...
        private static bool ComboW => Menu["W"].GetValue<MenuBool>("WC");
        private static bool RMaxDam => Menu["Misc"].GetValue<MenuBool>("RMaxDam");
        private static bool RKillable => Menu["R"].GetValue<MenuBool>("R");
        ...
        private static bool WInterrupt => Menu["W"].GetValue<MenuBool>("WInterrupt");
        ...
        private static bool UseEC => Menu["E"].GetValue<MenuBool>("EC");
        ...
        private static void OnMenuLoad()
        {
            ...
            var Keys = new Menu("Keys", "Keys Binding")
            {
                ...
                new MenuKeyBind("Flee", "Flee", System.Windows.Forms.Keys.Z, KeyBindType.Press)
            };
            Menu.Add(Keys);
            var Q = new Menu("Q", "Q")
            {
