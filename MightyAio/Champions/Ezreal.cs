...
namespace MightyAio.Champions
{
    internal class Ezreal
    {
        ...
        {
            Menu = new Menu("MightyEzreal", "Mighty Ezreal", true);
        ...
        public Ezreal()
        {
            ...
            W2.SetSkillshot(0.3f, 60f, 1200f, true, SkillshotType.Line);
            Q.SetSkillshot(0.3f, 60f, 2000f, false, SkillshotType.Line);
            W = new Spell(SpellSlot.W, 1150f);
            W.SetSkillshot(0.3f, 60f, 1200f, false, SkillshotType.Line);
            ...
            R.SetSkillshot(1.10f, 160f, 2000f, false, SkillshotType.Line);
            CreateMenu();
            Berlinfont = new Font(
        ...
        private static void DrawingOnOnDraw(EventArgs args)
        {
            ...
            if (drawQ && (Q.IsReady() || PermaShow)) Drawing.DrawCircle(p, Q.Range, Color.DarkCyan);
        ...
        private static void GameOnOnUpdate(EventArgs args)
        {
            ...
            if (Menu["Misc"].GetValue<MenuBool>("UseSkin") &&
            ...
            Stacktear();
            Baseutl();
            if (Menu["Misc"].GetValue<MenuBool>("AutoQ")) AutoQ();
            if (autolevel.GetValue<MenuBool>("autolevel")) Levelup();
        }
        ...
        {
            var BU = Menu["BaseUlt"].GetValue<MenuBool>("BaseUlt");
            var BUping = Menu["BaseUlt"].GetValue<MenuBool>("BasePing");
        ...
        {
            var BUBM = Menu["BaseUlt"].GetValue<MenuBool>("BaseBm");
            if (!Chatsent && BUBM)
            {
        ...
        private static void LastHit()
        {
            ...
            var useq = Menu["lasthit"].GetValue<MenuBool>("UseQ");
        ...
        private static void LaneClear()
        {
            ...
            var useql = Menu["laneclear"].GetValue<MenuBool>("UseQlasthit");
        ...
        {
            var rtarget = TargetSelector.GetTarget(4000);
        ...
        private static void Combo()
        {
            ...
            var QA = Menu["Combo"].GetValue<MenuBool>("UseQ");
            var WA = Menu["Combo"].GetValue<MenuBool>("UseW");
            var EQA = Menu["Combo"].GetValue<MenuBool>("UseEQ");
            var usegun = Items.GetValue<MenuBool>("GunbladeCombo");
            var useBOTRK = Items.GetValue<MenuBool>("BOTRKCombo");
            var Usespellbinder = Items.GetValue<MenuBool>("Use9");
            ...
            if (useBOTRK)
            {
                if (Player.CanUseItem((int) ItemId.Blade_of_the_Ruined_King) && target.Distance(Player) < 550)
                    Player.UseItem((int) ItemId.Blade_of_the_Ruined_King, target);
        ...
        private static void Killsteal()
        {
            ...
            var QA = Menu["KillSteal"].GetValue<MenuBool>("UseQ");
            var EQA = Menu["KillSteal"].GetValue<MenuBool>("UseEQ");
            var qdmg = Player.CalculatePhysicalDamage(target, Qdamage());
            ...
            var ksgun = Items.GetValue<MenuBool>("GunbladeKS");
            var BOTRKks = Items.GetValue<MenuBool>("BOTRKKS");

            if (Player.CanUseItem((int) ItemId.Hextech_Gunblade) && target.Distance(Player) < 700 &&
                target.Health < gunbladedmg && ksgun) Player.UseItem((int) ItemId.Hextech_Gunblade, target);
            if (Player.CanUseItem((int) ItemId.Blade_of_the_Ruined_King) && target.Distance(Player) < 550 &&
                target.Health < BOTRKdmg && BOTRKks) Player.UseItem((int) ItemId.Blade_of_the_Ruined_King, target);
            if (Player.CanUseItem((int) ItemId.Bilgewater_Cutlass) && target.Distance(Player) < 550 &&
                target.Health < BOTRKdmg && BOTRKks) Player.UseItem((int) ItemId.Bilgewater_Cutlass, target);
        ...
        {
            var target = TargetSelector.GetTarget(Q.Range);
            var QA = Menu["Harass"].GetValue<MenuBool>("UseQ");
            var WA = Menu["Harass"].GetValue<MenuBool>("UseW");
            var allMinions = GameObjects.GetMinions(ObjectManager.Player.Position, Q.Range);
            var useq = Menu["Harass"].GetValue<MenuBool>("LastHitQ");
        ...
        {
            if (!Menu["Misc"].GetValue<MenuBool>("UseE")) return;
        ...
        {
            var target = TargetSelector.GetTarget(1600);
            ...
            var stack = Menu["Misc"].GetValue<MenuBool>("Tear");
        ...
        {
            if (!Q.IsReady()) return;
            var targQ = Q.GetPrediction(target,false,-1,CollisionObjects.YasuoWall);
