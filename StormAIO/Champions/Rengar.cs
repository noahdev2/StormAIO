...
namespace StormAIO.Champions
{
    internal class Rengar
    {
        ...
        private static void InitSpell()
        {
            ...
            E.SetSkillshot(0.125f, 140f, 1500f, true, SkillshotType.Line);
        }
        ...
        private void DashOnOnDash(AIBaseClient sender, Dash.DashArgs args)
        {
            ...
            switch (Orbwalker.ActiveMode)
            {
                ...
                case OrbwalkerMode.LaneClear:
                    if (LaneClearMenu.QBool && Stacks < 4)
                        DelayAction.Add(args.Duration, () => Q.Cast());
                    if (LaneClearMenu.QBool && Stacks > 4 && ComboMenu.Prio.Index == 0)
                        DelayAction.Add(args.Duration, () => Q.Cast());
                    break;
            }
        }
        ...
        private static void OrbwalkerOnOnAction(object sender, OrbwalkerActionArgs args)
        {
            if (args.Type == OrbwalkerType.BeforeAttack)
            {
                ...
                var grass = ObjectManager.Get<GrassObject>().Where(x => x.Position == Game.CursorPos && x.IsValid)
                    .FirstOrDefault();
            ...
            if (args.Type == OrbwalkerType.AfterAttack)
                switch (Orbwalker.ActiveMode)
                {
                    ...
                    case OrbwalkerMode.Harass:
                        ...
                        break;
                    case OrbwalkerMode.LaneClear:
                        if (LaneClearMenu.QBool && Q.IsReady() && Stacks < 3)
                        {
                            Q.Cast();
                            Stacks += 1;
                            LastQ = Environment.TickCount + 0.25f + Game.Ping / 1000f;
                        ...
                        if (LaneClearMenu.QBool && Q.IsReady() && Stacks >= 4)
                        {
                            Q.Cast();
                            Stacks += 1;
                        }
            ...
            if (args.Type == OrbwalkerType.AfterAttack && args.Target is AITurretClient)
            {
                if (StructureClearMenu.QBool && Q.IsReady())
                {
                    Q.Cast();
                    Stacks += 1;
                }
                if (StructureClearMenu.StacKBool && Stacks < 4 && 4> EnergyStacks)
                {
        ...
        {
            if (ComboMenu.WBool && EnergyStacks <= 3) CastW();
            if (ComboMenu.EBool && EnergyStacks <= 3) CastE();
            Prio();
        }

        private static void Harass()
        {
            if (HarassMenu.WBool && EnergyStacks <= 3) CastW();
            if (HarassMenu.EBool && EnergyStacks <= 3) CastE();
            Prio();
        }
        ...
        private static void LaneClear()
        {
            ...
            if (Stacks > 4) return;
            if (minions != null && W.IsReady() && LaneClearMenu.WBool)
            {
            ...
            if (minions != null && E.GetDamage(minions) > minions.Health && E.IsReady() && LaneClearMenu.EBool)
            {
        ...
        private static void JungleClear()
        {
            ...
            if (jungles != null && E.IsReady() && JungleClearMenu.EBool)
            {
                if (LastE > Environment.TickCount) return;
            ...
            if (jungles != null && W.IsReady() && W.IsInRange(jungles) && JungleClearMenu.WBool)
            {
                if (LastW > Environment.TickCount) return;
        ...
        private static void CastQ()
        {
            ...
            var target = TargetSelector.GetTarget(270);
        ...
        private static void CastW()
        {
            ...
            var target = TargetSelector.GetTarget((float) (W.Range / 1.3));
        ...
        private static void Prio()
        {
            ...
            switch (ComboMenu.Prio.Index)
            {
                case 0:
                    ...
                    var targetQ = TargetSelector.GetTarget(270);
        ...
        {
            float a = 0;
            if (EnergyStacks >= 4) a = Q.GetDamage(t, DamageStage.Empowered);
        ...
        {
            float a = 0;
            if (EnergyStacks >= 4) a = W.GetDamage(t, DamageStage.Empowered);
        ...
        {
            float a = 0;
            if (EnergyStacks >= 4) a = E.GetDamage(t, DamageStage.Empowered);
