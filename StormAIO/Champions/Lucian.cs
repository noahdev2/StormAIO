...
namespace StormAIO.Champions
{
    internal class Lucian
    {
        ...
        private static bool UseE => champMenu["E"].GetValue<MenuBool>("EC");
        private static bool UseQC => champMenu["Q"].GetValue<MenuBool>("QC");
        private static bool UseQH => champMenu["Q"].GetValue<MenuBool>("QH");
        ...
        private static bool WLaneClear => champMenu["laneclear"].GetValue<MenuBool>("W");
        private static bool ELaneClear => champMenu["laneclear"].GetValue<MenuBool>("E");
        private static bool QjglClear => champMenu["laneclear"].GetValue<MenuBool>("QJ");
        private static bool WjglClear => champMenu["laneclear"].GetValue<MenuBool>("WJ");
        private static bool EjglClear => champMenu["laneclear"].GetValue<MenuBool>("EJ");
        private static bool KSQ => champMenu["KillSteal"].GetValue<MenuBool>("Q");
        private static bool KSW => champMenu["KillSteal"].GetValue<MenuBool>("W");
        private static bool KSR => champMenu["KillSteal"].GetValue<MenuBool>("R");
