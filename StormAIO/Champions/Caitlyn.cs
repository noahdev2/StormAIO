...
namespace StormAIO.Champions
{
    internal class Caitlyn
    {
        ...
        private static void InitSpell()
        {
            ...
            Q.SetSkillshot(0.70f, 120f, 2200f, false, false, SkillshotType.Line);

            W = new Spell(SpellSlot.W, 800f);
            W.SetSkillshot(0.25f, 80f, 2000f, false, false, SkillshotType.Circle);

            E = new Spell(SpellSlot.E, 750f);
            E.SetSkillshot(0.15f, 60f, 1600f, true, false, SkillshotType.Line);
        ...
        public Caitlyn()
        {
            ...
            {
                if (sender.IsMe) Game.Print(args.EndPos);
            };
